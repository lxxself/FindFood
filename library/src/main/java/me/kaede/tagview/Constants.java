...
public class Constants {
	...
	public static final float DEFAULT_TAG_DELETE_INDICATOR_SIZE = 12f;
	public static final float DEFAULT_TAG_LAYOUT_BORDER_SIZE = 1f;
	public static final float DEFAULT_TAG_RADIUS = 0;
	public static final int DEFAULT_TAG_LAYOUT_COLOR = Color.parseColor("#ffffff");
	public static final int DEFAULT_TAG_LAYOUT_COLOR_PRESS = Color.parseColor("#00BFFF");
	public static final int DEFAULT_TAG_TEXT_COLOR = Color.parseColor("#00BFFF");
	public static final int DEFAULT_TAG_DELETE_INDICATOR_COLOR = Color.parseColor("#00BFFF");
	public static final int DEFAULT_TAG_LAYOUT_BORDER_COLOR = Color.parseColor("#00BFFF");
