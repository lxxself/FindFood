...
public class TagView extends RelativeLayout {
	...
	public TagView(Context ctx, boolean clickable) {
		super(ctx, null);
	...
	public void drawTags() {
		...
		for (Tag item : mTags) {
			...
			// tag text
			final TextView tagView = (TextView) tagLayout.findViewById(R.id.tv_tag_item_contain);
			...
			tagView.setClickable(tag.clickable);
...
//		tagLayout.setId(listIndex);
	...
	public void defaultTags() {
		for (Tag item : mTags) {
			item.setLayoutColor(Constants.DEFAULT_TAG_LAYOUT_COLOR);
			item.setTagTextColor(Constants.DEFAULT_TAG_TEXT_COLOR);
			initTag(item);
		}
